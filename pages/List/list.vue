<template>
	<view class="container">
		<scroll-view class="nav" scroll-x="true" style="white-space: nowrap;">
			<view class="nav_item" :class="select == item.id ? 'active' : ''" v-for="(item, index) in nav" :key="index" @tap="change_nav" :data-selectIndex="index" :data-index="item.id" :data-page="item.page">
				<view>
					{{ item.name }}
			...
			<view v-for="(item, index) in data[select]" :key="index" class="item">
				...
				<view class="imgs">
					<scroll-view scroll-x="true" enable-flex="true" style="white-space: nowrap;">
						<view v-for="(itm, idx) in item.original_image" @tap="bigImg" :data-list="item.original_image" :data-index="idx" :key="idx" class="img_item">
				...
				<view class="handle_after p24">
					...
					<view class="imgs">
						<scroll-view scroll-x="true" enable-flex="true" style="white-space: nowrap;">
							<view v-for="(it, idx) in item.end_image" @tap="bigImg" :data-list="item.end_image" :data-index="idx" :key="idx" class="img_item">
